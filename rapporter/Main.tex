...
\begin{center}
	\begin{tabular}{|l|l| p{5cm} |l|l| }
		...
		Version &  Date  & Changes     & Sign & Reviewed \\ \hline
		  ...
		  0.3   & \today & Changes to the problem specification  & AM  &  \\ \hline
	\end{tabular}
\end{center}
\newpage
...
The aim of this thesis is to examine the possibilities to automatically detect and locate facial marks and classify them as permanent or non-permanent marks. Several different segmentation and digital image processing algorithms will be explored to detect facial marks. The thesis will also explore how to create a facial grid from facial landmarks, to give the facial marks a position.
